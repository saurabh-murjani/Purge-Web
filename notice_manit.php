...
<html>
	...
	<body>
		...
		<div class="remains">
		<span class="events"><h3 id='yo'>Notices Passed for promoting Cleanliness (MANIT)</h3></span>
		<h2 class="content">
			Purge has passed various notices in the college campus with the permission of the Director of the college to prevent haphazard disposal of waste in the college campus.
		</h2>
		</div>
		<div class="looter">
