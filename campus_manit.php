	...
	<body>
		...
		<div id='side-pane'>
			...
			<ul class='nav'>
				...
				<li class="active main1"> <a href="events.php"><h2> Events</h2> </a> </li>
		...
		<div class="remains">
		<span class="events"><h3 id='yo'>Campus Cleaning Drive(MANIT)</h3></span>
		<h2 class="content"> Purge organized a campus cleaning drive in MANIT, Bhopal. More than 300 students participated in the campaign. The streets of whole campus were cleaned by the students. All of the plastic and other waste was collected from the streets and was packed in bags for Nagar Nigam Bhopal to dispose the waste properly.<p> The students along with the faculty co-ordinators persuaded all the people to keep the academic and residential area of the campus free from plastic and other waste.</h2>
		</div>
		<div class="looter">
			<div class="kar"><a id="kaise">About PURGE</a><br>
			<a id="aise">Purge is an initiative by students<br>of MANIT to reduce polythene<br> usage in the country.</a></div>
			<div  class="aao"><a>Polythene Usage Reduction for Greener Environment.</a><br>
					<a>	Contact us at purge.manit@gmail.com
			</a><br>
			<a> ©PURGE_MANIT2015</a></div>
